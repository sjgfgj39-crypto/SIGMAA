...
export const StudentDashboard: React.FC<StudentDashboardProps> = ({
  ...
  const bookmarkedIds = SupabaseService.getBookmarks();
  ...
  return (
    <div className="max-w-5xl mx-auto py-6 px-4 sm:px-6">
      {/* Student Welcome Header (Personalized, Clean, No XP or Leaderboards) */}
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            <div className="flex items-center space-x-2">
              ...
              <span className="px-2 py-0.5 rounded text-[10px] font-mono font-semibold bg-[#1F1F1F] text-[#10B981] border border-[#2F2F2F]">
                {user.classGrade}
              </span>
            </div>
        ...
        <div className="flex items-center space-x-3">
          {onOpenEditProfile && (
            <button
              ...
              className="flex items-center space-x-1.5 px-3.5 py-1.5 rounded-full bg-[#1A1A1A] hover:bg-[#242424] text-white hover:text-[#10B981] border border-[#2E2E2E] hover:border-[#10B981]/50 text-xs font-semibold transition-all cursor-pointer shadow-sm"
