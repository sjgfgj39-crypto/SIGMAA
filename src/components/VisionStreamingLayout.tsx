    ...
    <div className="min-h-screen bg-[#0A0A0C] text-[#E5E5E5] relative overflow-x-hidden flex flex-col items-center justify-start p-2 sm:p-4 md:p-6 lg:p-8 font-sans selection:bg-[#10B981] selection:text-[#0D0D0D]">
            ...
            {activeModule || currentTab !== 'modules' ? (
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 lg:gap-6">
                ...
                <div className="lg:col-span-8 xl:col-span-9 flex flex-col space-y-6">
                  ...
                  {featuredModule && (
                    <div className="relative rounded-3xl overflow-hidden border border-white/[0.12] bg-gradient-to-br from-[#16201B] via-[#15151B] to-[#0E0E12] p-6 sm:p-8 lg:p-10 shadow-2xl min-h-[340px] sm:min-h-[380px] flex flex-col justify-between group">
                      {/* Geometric SVG Background Accent mimicking the vibrant movie artwork */}
                      <div className="absolute right-[-5%] top-[-10%] w-[55%] h-[120%] pointer-events-none opacity-40 group-hover:opacity-50 transition-opacity">
                        <ModuleCoverArt
      ...
      <footer className="w-full max-w-[1360px] mt-6 py-3 px-4 flex flex-col sm:flex-row items-center justify-between text-xs text-[#71717A] z-10">
        ...
        <div className="flex items-center space-x-4 mt-2 sm:mt-0">
          ...
          <button onClick={onToggleRole} className="hover:text-white transition-colors">
            Peran: {user.role === 'teacher' ? 'Guru' : 'Siswa'}
          </button>
          {onLogout && (
